...
{
    // Core routing
    layout.add (makeBool ("reverb_enabled",  "Reverb Enable", true));
    layout.add (makeBool ("reverb_kill_dry",  "Wet Only",      false));
    ...
    // ================================================================
    layout.add (makeChoice ("decay_profile_mode",     "Decay Profile",
                            ReverbParameters::decayProfileModeChoices (),     0)); // default Manual 3-Band
    layout.add (makeChoice ("decay_profile_coupling", "Decay Coupling",
    ...
    // ================================================================
    layout.add (makeBool  ("decay_learn",       "Learn (One-Shot)", false));
    layout.add (makeBool  ("decay_learn_reset",  "Reset Learned",    false));
    layout.add (makeFloat ("decay_learn_strength", "Learn Strength",
                           { 0.0f, 1.0f, 0.01f },                0.5f,  "%"));
    layout.add (makeFloat ("decay_learn_window_s", "Learn Window (s)",
