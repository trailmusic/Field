...
: AudioProcessorEditor (&p), proc (p), presetManager (proc.apvts, nullptr)
{
    ...
    // Add 3D vertical sliders to leftMetersContainer
    leftMetersContainer.addAndMakeVisible (inputSlider);
    leftMetersContainer.addAndMakeVisible (outputSlider);
    leftMetersContainer.addAndMakeVisible (mixSlider);
    leftMetersContainer.addAndMakeVisible (inputLabel);
    leftMetersContainer.addAndMakeVisible (outputLabel);
    leftMetersContainer.addAndMakeVisible (mixLabel);
...
void MyPluginAudioProcessorEditor::performLayout()
{
    ...
    // 2) main XY area + vertical meters on right side
    {
        ...
        // Split the remaining area: left meters container, left content container, and right sliders container
        auto metersArea = r.removeFromLeft (metersStripW);    // Left meters area first
        auto leftMetersArea = r.removeFromRight (metersStripW); // Right sliders area
        auto leftArea   = r; // whatever remains in the middle
        ...
        leftMetersContainer.setBounds (leftMetersArea); // Right sliders container
        metersContainer.setBounds       (metersArea);   // Left meters container
        
        // Layout the 3D vertical sliders in leftMetersContainer
        auto sliderArea = leftMetersArea.reduced (10);
        ...
        DBG("leftMetersArea (right sliders): " << leftMetersArea.toString());
        ...
        DBG("leftMetersContainer visible: " << leftMetersContainer.isVisible());
