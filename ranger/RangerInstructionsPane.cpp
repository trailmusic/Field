...
void RangerInstructionsPane::setupInstructions()
{
    juce::String instructions = 
        ...
        "AUDITION SYSTEM\n"
        "---------------\n"
        "The Plots tab now includes a comprehensive audition system:\n"
        "- Impulse Response: Test filter with delta function input\n"
        "- Step Response: Test filter with unit step input\n"
        "- Magnitude Response: Frequency domain analysis\n"
        "- Normalization Options: Peak, Energy, or DC Unity\n"
        "- Export Capabilities: Save audition data as CSV\n"
        "- Real-time Testing: Generate and compare filter responses\n\n"
        "DOCUMENTATION SYSTEM\n"
        "--------------------\n"
        "This Instructions tab provides comprehensive documentation:\n"
        "- Quick Start Guide: Get started immediately\n"
        "- Detailed Workflows: Step-by-step procedures\n"
        "- Troubleshooting: Common issues and solutions\n"
        "- Integration Notes: Field plugin compatibility\n"
        "- Advanced Features: Professional usage techniques\n\n"
        "TROUBLESHOOTING\n"
        "---------------\n"
